        ...
        if (isFocused() && v != null) {
            ...
            if (v instanceof RelativeLayout) {
                RelativeLayout rl = (RelativeLayout) v;
                 RelativeLayout child_rl =(RelativeLayout) rl.getChildAt(0);
//                ImageView tmepView = (ImageView) child_rl.getChildAt(0);
//                TextView tv = (TextView) rl.getChildAt(1);
//                tv.setTextColor(Color.WHITE);
//                v.setBackgroundResource(R.color.color_background_blue2);
                Rect r = mTmpSelectedRect;
                child_rl.getGlobalVisibleRect(r);//Rect(62, 152 - 398, 512) 计算出imageview在屏幕的坐标点
